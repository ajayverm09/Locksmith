...
const BlogDetails = () => {
  ...
  return (
    <div className="w-full overflow-hidden">
      {/* HERO SECTION */}
      <motion.div
        className="relative h-[260px] sm:h-[350px] md:h-[420px] flex items-center justify-center text-center text-white"
        style={{
      ...
      >
        ...
        <div className="relative z-10 px-4 max-w-3xl">
          <motion.span
            className="bg-yellow-500 text-black px-3 py-1 rounded text-xs sm:text-sm font-semibold inline-block"
          ...
          <motion.h1
            className="text-2xl sm:text-3xl md:text-5xl font-extrabold mt-4 leading-snug"
            initial={{ opacity: 0, y: 20 }}
          ...
          <motion.div
            className="mt-3 flex flex-wrap justify-center gap-6 text-xs sm:text-sm text-gray-200"
            initial={{ opacity: 0 }}
      ...
      {relatedBlogs.length > 0 && (
        <motion.div
          className="bg-gray-50 py-8 sm:py-12 px-4 sm:px-6 md:px-12"
          initial="hidden"
          animate="visible"
          variants={fadeUp}
        >
          <div className="max-w-7xl mx-auto">
            <h2 className="text-xl sm:text-2xl font-extrabold mb-6 text-gray-900">
              Related Blogs
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {relatedBlogs.map((rel, idx) => (
                <motion.div
                  key={rel.id}
                  className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition transform hover:scale-[1.02]"
                ...
                >
                  <Link to={`/blog/${rel.id}`}>
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <span className="text-indigo-600 font-semibold hover:underline text-xs sm:text-sm">
                        Read More »
                      </span>
                    </div>
